...
import { createMahasiswa, perbaruiMahasiswa } from '../services/Service'

export default class PerbaruiUserMahasiswa extends Component{
    constructor(props){
        super(props)
        this.state = {
            loader: false,
            error: '',
            namaMahasiswa: props.route.params.nama_mahasiswa,
            nim: props.route.params.nim.toString(),
            password: ''
        }
    }
    ...
    perbarui = async () => {
        try {
            let data = {
                id_mst_mahasiswa: this.props.route.params.id_mst_mahasiswa,
            ...
            const {success} = await perbaruiMahasiswa(data)
